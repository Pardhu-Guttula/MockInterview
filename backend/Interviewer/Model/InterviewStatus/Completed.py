...
class CompletedSlots:
    ...
    def get_completed_slots(self,data):
        try:
            interviewerID = data["interviewerID"]
            query = f"SELECT intervieweeID, slotID, time FROM InterviewFact WHERE interviewStatus = 'Completed' AND interviewerID = '{interviewerID}'"
